...
<div class="container-fluid py-5">   
    ...
    <form action="{{route('caos.modulo.index')}}" class="form-search" method="GET">
        <div class="col-sm-12">
            ...
            <a href="{{route('caos.modulo.create')}}" type="button" class="AddModuloModal_btn input-group-text border-0 animate__animated animate__bounce" style="background: transparent;border: none; white-space: nowrap;" data-html="true" data-placement="top" data-toggle="popover" title="Novo registro"><i class="fas fa-plus"></i></a>
     ...
     $(document).on('click','.delete_modulo_btn',function(e){   ///inicio delete 
            ...
            Swal.fire({
             ...
             if(result.isConfirmed){             
                $.ajax({
                    url: '/caos/modulo/delete-modulo/'+id,
                    type: 'POST',
                    dataType: 'json',
                    data:{                        
                        'id': id,                                         
