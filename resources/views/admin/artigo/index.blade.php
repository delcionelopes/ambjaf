                    ...
                    <table class="table table-hover">
                        ...
                        @forelse($artigos as $artigo)   
                            <tr id="artigo{{$artigo->id}}">                                
                                ...
                                <td>                                    
                                        <div class="btn-group">                                           
                                            <a href="{{route('admin.artigos.edit',['id'=>$artigo->id,'color'=>$color])}}" type="button" data-id="{{$artigo->id}}" class="edit_artigo fas fa-edit" style="background:transparent;border:none; color:black; white-space: nowrap;" data-html="true" data-placement="left" data-toggle="popover" title="Editar"></a>
