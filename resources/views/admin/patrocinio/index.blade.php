...
<div class="container-fluid py-5">   
    ...
    <form action="{{route('admin.patrocinios.index',['color'=>$color])}}" class="form-search" method="GET">
        <div class="col-sm-12">
            ...
            <a href="{{route('admin.patrocinios.create',['color'=>$color])}}" type="button" class="AddPatrocinio_btn input-group-text border-0 animate__animated animate__bounce" style="background: transparent;border: none; white-space: nowrap;" data-html="true" data-placement="top" data-toggle="popover" title="Novo registro"><i class="fas fa-plus"></i></a>
            </div>            
            </div>        
            </form>                     
